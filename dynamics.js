/* 
Картинки берем с https://jsonplaceholder.typicode.com/photos. Там их 5000 штук.
...
Дальше кнопки назад - вперед изменяют ID картинки. Кнопки привязаны к длине массива.
После изменения ID картинки читаем ее URL и изменяем элемент img.src
